...
//execute before every testcase
	...
	//automatically start when a testcase start when a testcase success
...
// execute when a testcase failes
	...
	e.printStackTrace();// to print the error in a report
	}
	...
	//green uparrow denotes override
	// when a test case skips
